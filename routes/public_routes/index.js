...
const { register_user, login_user, verify_reset_password_OTP, reset_user_password_request, verify_OTP_and_create_password,confirm_email } = require('../../controllers/auth_controllers');
...
router.get('/confirm-email', confirm_email)
